...
const createMedicalReport = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const report = yield medicalReport_service_1.medicalReportService.createMedicalReport(req.body, req.user);
...
const getAllMedicalReports = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { data, total } = yield medicalReport_service_1.medicalReportService.getAllMedicalReports(req.query);
